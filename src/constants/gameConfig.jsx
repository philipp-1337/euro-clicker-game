  ...
  unlockRoadmap: [
    {
      ...
      unlockType: "money",
      scope: "run",
      availabilityStrategy: "runtimeBoolean",
      unlockStateKey: "isInvestmentUnlocked",
      requirementKey: "investmentUnlockCost",
    ...
    },
    {
      ...
      unlockType: "money",
      scope: "career",
      availabilityStrategy: "prestigeThreshold",
      requirementKey: "prestigeThresholdMoney",
    ...
    },
    {
      ...
      requirementKey: "craftingUnlockCost",
      secondaryRequirementKey: "craftingUnlockPrestige",
