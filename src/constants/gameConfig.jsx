  ...
  unlockRoadmap: [
    {
      ...
      description: "Build your first 10 € to unlock the five active income lanes.",
      unlockType: "money",
      scope: "run",
      progressStrategy: "segments",
      readyWhen: { type: "threshold", key: "money", value: 10 },
      reachedWhen: { type: "threshold", key: "money", value: 10 },
      progressSegments: [
        { key: "money", value: 10, start: 0, end: 100 },
      ],
      remainingRequirements: [
        { key: "money", value: 10, format: "money" },
      ],
      readyLabel: "Income streams unlocked",
      ctaLabel: "Reach 10 €",
      previewText: "Unlock five active income streams and move beyond the starter click.",
    },
    {
      id: "tryAllIncomeStreams",
      title: "Next level Income",
      description: "Use each of the five unlocked income streams once to open the full upgrade layer.",
      unlockType: "buttonUsage",
      scope: "run",
      progressStrategy: "segments",
      readyWhen: { type: "threshold", key: "clickedButtonsCount", value: 5 },
      reachedWhen: { type: "threshold", key: "clickedButtonsCount", value: 5 },
      progressSegments: [
        { key: "clickedButtonsCount", value: 5, start: 0, end: 100 },
      ],
      remainingRequirements: [
        { key: "clickedButtonsCount", value: 5, format: "count", unitLabel: "income streams" },
      ],
      readyLabel: "Upgrade tabs unlocked",
      ctaLabel: "Use all 5 incomes",
      compactProgressTextPrefix: "Try",
      previewText: "Open the full upgrade layer by testing each active income stream once.",
    },
    {
      id: "firstManager",
      title: "Hire a Manager",
      description: "Buy your first manager to start turning active income into automation.",
      unlockType: "manager",
      scope: "run",
      progressStrategy: "segments",
      targetValueOverrideKey: "nextManagerCost",
      readyWhen: { type: "threshold", key: "money", target: "targetValue" },
      reachedWhen: { type: "threshold", key: "managersOwnedCount", value: 1 },
      progressSegments: [
      ...
      ctaLabel: "Buy a manager",
      previewText: "Managers automate your income loops and make the first passive rhythm visible.",
    },
    {
      id: "floatingClickUpgrade",
      title: "Boost the Floating Euro",
      description: "Upgrade the floating euro button once so the manual click has more punch.",
      unlockType: "floatingClickUpgrade",
      scope: "run",
      progressStrategy: "segments",
      targetValueOverrideKey: "floatingClickUpgradeCost",
      readyWhen: { type: "threshold", key: "money", target: "targetValue" },
      reachedWhen: { type: "threshold", key: "floatingClickValueLevel", value: 2 },
      progressSegments: [
        { key: "money", target: "targetValue", start: 0, end: 100 },
      ],
      remainingRequirements: [
      ...
      readyLabel: "Ready to boost",
      ctaLabel: "Upgrade floating euro",
      previewText: "Make active play feel stronger before the economy opens into investments.",
    },
    {
      id: "investments",
      title: "Investments",
